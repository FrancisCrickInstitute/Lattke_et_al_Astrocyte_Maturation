...
#add count matrix from re-analysis of published reference datasets
...
t1 = read_csv(paste0(in_dir,"/matrix_in vitro Hasel17 Tiwari18.csv"))
t2 = t1
t2[,-1] = floor(t1[,-1])
mat3 = t2

count_tab_merged = cbind(mat1[,-1], mat3[,-1])
...
l1[["mature"]] = v1
l1[["mature_low_in_BMP"]] = intersect(v1, cb$gene[cb$reg_Astr_BMP.vs.Astr_2m < 0])
l1[["mature_low_in_mESC_CNTF"]] = intersect(v1, cb$gene[cb$reg_Astr_mESC_CNTF.vs.Astr_2m < 0])
l1[["mature_low_in_prim"]] = intersect(v1, cb$gene[cb$reg_Astr_prim.vs.Astr_2m < 0])
l1[["mature_low_in_all"]] = intersect(intersect(l1$mature_low_in_BMP, l1$mature_low_in_mESC_CNTF), 
                                      l1$mature_low_in_prim)
l1[["mature_low_in_BMP_and_mESC_CNTF"]] = intersect(l1$mature_low_in_BMP, l1$mature_low_in_mESC_CNTF)
l1[["mature_low_in_BMP_and_prim"]] = intersect(l1$mature_low_in_BMP, l1$mature_low_in_prim)
l1[["mature_low_in_BMP_only"]] = l1$mature_low_in_BMP[!(l1$mature_low_in_BMP %in% 
                                                          c( l1$mature_low_in_mESC_CNTF, 
                                                             l1$mature_low_in_prim))] 
...
GOI_tab = read_csv(paste0(in_dir,"/Gene of interest table 21-02-05.csv"))
